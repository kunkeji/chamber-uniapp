		...
		<view class="container-main" v-if="loadEnd">
			...
			<view class="main-form">
				...
				<view class="main-form-item">
					...
					<view class="main-form-info">
						<textarea v-model="content" auto-height maxlength="-1" style="min-height: 200rpx;width: 100%;" placeholder="请输入" placeholder-class="placeholder" />
					</view>
				</view>
				<!-- 详情图片 -->
			...
			<view class="main-bottom">
				<view class="harmless-content-button" :style="{ background: themeColor }" @click="submitCheck()">提交审核</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 提交审核
			submit() {
				this.$util.request("demand.businessAdd", {
